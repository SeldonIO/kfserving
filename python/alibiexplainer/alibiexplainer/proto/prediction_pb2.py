...
_SELDONMESSAGELIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='seldonMessages', full_name='seldon.protos.SeldonMessageList.seldonMessages',
            index=0,
...
_SELDONMESSAGE.fields_by_name['binData'].containing_oneof = _SELDONMESSAGE.oneofs_by_name[
    'data_oneof']
_SELDONMESSAGE.oneofs_by_name['data_oneof'].fields.append(
    _SELDONMESSAGE.fields_by_name['strData'])
_SELDONMESSAGE.fields_by_name['strData'].containing_oneof = _SELDONMESSAGE.oneofs_by_name[
    'data_oneof']
_SELDONMESSAGE.oneofs_by_name['data_oneof'].fields.append(
    _SELDONMESSAGE.fields_by_name['jsonData'])
_SELDONMESSAGE.fields_by_name['jsonData'].containing_oneof = _SELDONMESSAGE.oneofs_by_name[
    'data_oneof']
...
_DEFAULTDATA.fields_by_name[
    'tftensor'].message_type = tensorflow_dot_core_dot_framework_dot_tensor__pb2._TENSORPROTO
...
Meta = _reflection.GeneratedProtocolMessageType('Meta', (_message.Message,), {
    ...
    'RequestPathEntry': _reflection.GeneratedProtocolMessageType('RequestPathEntry',
                                                                 (_message.Message,), {
...
SeldonMessageList = _reflection.GeneratedProtocolMessageType('SeldonMessageList',
                                                             (_message.Message,), {
